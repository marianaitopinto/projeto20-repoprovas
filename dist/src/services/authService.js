        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    checkEmail = _b.sent();
                    if (checkEmail)
                        throw new appError_1.AppError("E-mail is already registered", 409);
                    return [4 /*yield*/, bcrypt_1["default"].hash(password, SALT_ROUNDS)];
                case 2:
                    passwordHash = _b.sent();
                    return [4 /*yield*/, authRepository.insertUser({ email: email, password: passwordHash })];
                case 3:
                    _b.sent();
                    return [2 /*return*/];
            }
